...
public class Links extends TableImpl<LinksRecord> {
     ...
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_UPDATED_AT = createField(DSL.name("LAST_UPDATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");

    /**
     * The column <code>LINKS.LAST_CHECK_AT</code>.
     */
    public final TableField<LinksRecord, OffsetDateTime> LAST_CHECK_AT = createField(DSL.name("LAST_CHECK_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
