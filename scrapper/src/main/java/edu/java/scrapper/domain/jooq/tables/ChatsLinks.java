...
public class ChatsLinks extends TableImpl<ChatsLinksRecord> {
    ...
    /**
     * The column <code>CHATS_LINKS.ID</code>.
     */
    public final TableField<ChatsLinksRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    public List<UniqueKey<ChatsLinksRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.CHAT_LINK_UNIQUE);
    }

    @Override
    @NotNull
    public List<ForeignKey<ChatsLinksRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_34D, Keys.CONSTRAINT_34D8);
    }
    ...
    public Chats chats() {
        if (_chats == null)
            _chats = new Chats(this, Keys.CONSTRAINT_34D);
    ...
    public Links links() {
        if (_links == null)
            _links = new Links(this, Keys.CONSTRAINT_34D8);
