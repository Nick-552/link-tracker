...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
     ...
     */
    public void setLastUpdatedAt(@NotNull OffsetDateTime value) {
        set(2, value);
    }
    ...
    /**
     * Setter for <code>LINKS.LAST_CHECK_AT</code>.
     */
    ...
    /**
     * Getter for <code>LINKS.LAST_CHECK_AT</code>.
     */
    @jakarta.validation.constraints.NotNull
    @NotNull
    ...
    public Field<OffsetDateTime> field4() {
        return Links.LINKS.LAST_CHECK_AT;
    }
    ...
    @Override
    @NotNull
    public LinksRecord values(@Nullable Long value1, @NotNull String value2, @NotNull OffsetDateTime value3, @NotNull OffsetDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    @ConstructorProperties({ "id", "url", "lastUpdatedAt", "lastCheckAt" })
    public LinksRecord(@Nullable Long id, @NotNull String url, @NotNull OffsetDateTime lastUpdatedAt, @NotNull OffsetDateTime lastCheckAt) {
        super(Links.LINKS);
